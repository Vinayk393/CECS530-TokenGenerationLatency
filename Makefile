...
help:
	@echo "Usage:"
	@echo "  make smoke              Quick sample test case"
	@echo "  make bench              Full benchmark suite (needs model ~2.2GB)"
	@echo "  make bench-07-modeled   Q4/Q8 speedup projected from F16 baseline"
	@echo "  make bench-07-llamacpp  Measured Q4/Q8 via llama.cpp GGUF files"
	@echo "  make graphs             Generate all paper figures from CSVs"
	@echo "  make verify             Smoke test + pytest"
	@echo "  make clean              Remove graphs and pycache"
	@echo ""
	@echo "Options:"
	@echo "  MODEL=<hf-id>   Override model (default: TinyLlama-1.1B)"
	@echo "  PEAK_BW=120     Peak bandwidth in GB/s  (M4: 120, M2: 100)"
