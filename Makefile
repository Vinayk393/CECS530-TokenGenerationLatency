...
help:
	@echo "Usage:"
	@echo "  make smoke              Run fast smoke test"
	@echo "  make bench              Run all benchmark scripts"
	@echo "  make bench-07-modeled   Run modeled Q4/Q8 speedup projection"
	@echo "  make bench-07-llamacpp  Run llama.cpp Q4/Q8 benchmark path"
	@echo "  make graphs             Generate paper figures"
	@echo "  make verify             Run smoke test and pytest"
	@echo "  make clean              Remove generated graph/cache files"
	@echo ""
	@echo "Options:"
	@echo "  MODEL=...               Override HuggingFace model"
	@echo "  PEAK_BW=120             Peak bandwidth for utilization calculation"
